...
package pub.xylibrary.surface.view;
...
import pub.xylibrary.surface.activity.WebViewActivity;
import pub.xylibrary.bone.util.CommonUtil;

/**自定义带链接文本
 * @author Lemon
 * @use TextUrlView.getText(...);
 */
public class TextUrlView extends ClickableSpan {
	private static final String TAG = "MyURLSpan";

	private Activity context;
	private String url;
	private String title;
	public TextUrlView(Activity context, String url, String title) {
	...
	public static SpannableStringBuilder getText(Activity context, Spannable spannable, String title) {
		...
		if (urls != null) {
			for (URLSpan urlSpan : urls) {
				if (urlSpan != null) {
					TextUrlView URLText = new TextUrlView(context, urlSpan.getURL(), title);
					builder.setSpan(URLText, spannable.getSpanStart(urlSpan), spannable
