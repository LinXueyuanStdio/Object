...
import pub.xylibrary.bone.base.BaseBottomWindow;
import pub.xylibrary.bone.util.CommonUtil;
import pub.xylibrary.bone.util.ContactUtil;
import pub.xylibrary.bone.util.EditTextUtil;
...
public class EditTextInfoWindow extends BaseBottomWindow implements OnClickListener {
	...
	public static Intent createIntent(Context context, String key, String value) {
		return createIntent(context, key, value, "pub.xylibrary");
	}
	/**
	 * @param context
	 * @param key
	...
	public static Intent createIntent(Context context, int type, String key, String value) {
		return createIntent(context, type, key, value, "pub.xylibrary.bone");
	}
	/**
	 * @param context
	 * @param type
