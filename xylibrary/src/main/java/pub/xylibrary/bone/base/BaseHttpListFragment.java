...
package pub.xylibrary.bone.base;
...
import pub.xylibrary.bone.interfaces.AdapterCallBack;
import pub.xylibrary.bone.interfaces.OnReachViewBorderListener;
import pub.xylibrary.bone.interfaces.OnStopLoadListener;
import pub.xylibrary.bone.manager.HttpManager;
import pub.xylibrary.surface.view.xlistview.XListView;
import pub.xylibrary.surface.view.xlistview.XListView.IXListViewListener;
...
implements HttpManager.OnHttpResponseListener, IXListViewListener, OnStopLoadListener {
	...
	public void setList(AdapterCallBack<BA> callBack) {
		...
		if (adapter != null && adapter instanceof pub.xylibrary.bone.base.BaseAdapter) {
			((pub.xylibrary.bone.base.BaseAdapter<T>) adapter).setOnReachViewBorderListener(
