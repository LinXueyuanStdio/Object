...
import pub.xylibrary.bone.interfaces.CacheCallBack;
import pub.xylibrary.bone.interfaces.OnStopLoadListener;
import pub.xylibrary.bone.manager.CacheManager;
...
public abstract class BaseListActivity<T, LV extends AbsListView, BA extends BaseAdapter> extends BaseActivity {
	...
	public void initData() {// 必须调用
		...
		isToSaveCache = Settings.cache && cacheCallBack != null && cacheCallBack.getCacheClass() != null;
